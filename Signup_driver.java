...
public class Signup_driver extends AppCompatActivity {
    ...
    EditText first_name,middle_name,last_name,addres,email,password,RePassword,gcash,user_name,plate_number;
    RadioButton male_rb;
    String gender;
    ...
    private static final String url="http://10.0.2.2/tricycleHailingSystem/fileupload_drivers.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        browse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dexter.withActivity(Signup_driver.this)
    ...
    private void uploaddatatodb() {
        ...
        plate_number= (EditText) findViewById(R.id.d2);
        gcash= (EditText) findViewById(R.id.gcash);
        ...
        final String gcashA = gcash.getText().toString().trim();
        final String user_nameA = user_name.getText().toString().trim();
        final String plate_numberA = plate_number.getText().toString().trim();
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("status", passwordA);
                map.put("gcash", gcashA);
                map.put("user_name", user_nameA);
                map.put("plate_number", plate_numberA);
                return map;
            }
        };

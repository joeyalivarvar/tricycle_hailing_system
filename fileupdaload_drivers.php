...
$query="select * from driver where user_name='".$user_name."'";  // $usename=$_GET['username'];
...
//first_name,middle_name,last_name,address,email,gender,password,image
			...
			$qry="INSERT INTO driver (first_name,middle_name,last_name,address,email,gender,password,image,status,gcash,user_name,plate_number)
			      VALUES ('$first_name','$middle_name','$last_name','$address','$email','$gender','$password','$filename','unconfirm','$gcash','$user_name','$plate_number')";
